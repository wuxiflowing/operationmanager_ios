...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    oUpLimitValueLb.text = [NSString stringWithFormat:@"%@mg/L",JKSafeNull(model.oxyLimitUp3)];
    ...
    oDownLimitValueLb.text = [NSString stringWithFormat:@"%@mg/L",JKSafeNull(model.oxyLimitDown3)];
    ...
    if ([JKSafeNull(model.electricityUp3) isEqualToString:@""]) {
    ...
    if ([JKSafeNull(model.electricityDown3) isEqualToString:@""]) {
