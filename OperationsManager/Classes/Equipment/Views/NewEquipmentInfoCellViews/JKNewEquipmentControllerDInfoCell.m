...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    oUpLimitValueLb.text = [NSString stringWithFormat:@"%@mg/L",JKSafeNull(model.oxyLimitUp4)];
    ...
    oDownLimitValueLb.text = [NSString stringWithFormat:@"%@mg/L",JKSafeNull(model.oxyLimitDown4)];
    ...
    if ([JKSafeNull(model.electricityUp4) isEqualToString:@""]) {
    ...
    if ([JKSafeNull(model.electricityDown4) isEqualToString:@""]) {
