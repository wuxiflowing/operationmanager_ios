...
@interface JKInstallWaitInfoVC () <UITableViewDelegate, UITableViewDataSource, JKTaskTopCellDelegate, JKInstallationOrderCellDelegate>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray *dataSource;
@end

@implementation JKInstallWaitInfoVC
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (UIViewController *vc in marr) {
        if ([vc isKindOfClass:[JKInstallWaitInfoVC class]]) {
