...
//    }];
    ...
    if (model.matnerMembName.length == 0) {
        pondNameLb.text = [NSString stringWithFormat:@"养殖管家：%@",model.txtHKName];
    } else {
        pondNameLb.text = [NSString stringWithFormat:@"监控人员：%@",model.matnerMembName];
    }
