...
//    }];
    ...
    if (model.txtHKName.length == 0) {
        deviceNoLb.text = [NSString stringWithFormat:@"监控人员：%@",model.matnerMembName];
    } else {
        deviceNoLb.text = [NSString stringWithFormat:@"养殖管家：%@",model.txtHKName];
    }
